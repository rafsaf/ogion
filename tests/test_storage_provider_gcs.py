...
def test_gcs_post_save_no_google_bucket_upload_path(
    ...
    bucket_mock.blob.assert_called_once_with("fake_env_name/fake_backup.zip")
...
list_blobs_long_no_upload_path = [
    BlobInCloudStorage("fake_env_name/file_20230427_0105.zip"),
    BlobInCloudStorage("fake_env_name/file_20230127_0105.zip"),
    BlobInCloudStorage("fake_env_name/file_20230426_0105.zip"),
    BlobInCloudStorage("fake_env_name/file_20230227_0105.zip"),
    BlobInCloudStorage("fake_env_name/file_20230425_0105.zip"),
    BlobInCloudStorage("fake_env_name/file_20230327_0105.zip"),
]


@pytest.mark.parametrize("gcs_method_name", ["_clean", "safe_clean"])
def test_gcs_clean_file_with_google_bucket_upload_path(
    tmp_path: Path, monkeypatch: MonkeyPatch, gcs_method_name
):
    gcs = GoogleCloudStorage()
...
@pytest.mark.parametrize("gcs_method_name", ["_clean", "safe_clean"])
def test_gcs_clean_file_no_google_bucket_upload_path(
    tmp_path: Path, monkeypatch: MonkeyPatch, gcs_method_name
):
    gcs = GoogleCloudStorage()
    ...
    bucket_mock.blob.assert_any_call("fake_env_name/file_20230127_0105.zip")
    bucket_mock.blob.assert_any_call("fake_env_name/file_20230227_0105.zip")
    bucket_mock.blob.assert_any_call("fake_env_name/file_20230425_0105.zip")
    bucket_mock.blob.assert_any_call("fake_env_name/file_20230327_0105.zip")
