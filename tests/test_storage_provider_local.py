...
def test_local_debug_clean_file() -> None:
    ...
    assert fake_backup_file_age_path3.exists()
    assert fake_backup_file_age_path4.exists()
...
def test_local_debug_clean_folder() -> None:
    ...
    fake_backup_file_age_path4.mkdir()
    fake_backup_file_age_path2 = (
        fake_backup_dir_path / "fake_backup2_20230801_0000_file.age"
    )
    fake_backup_file_age_path2.mkdir()
    fake_backup_file_age_path3 = (
        fake_backup_dir_path / "fake_backup3_20230801_0000_file.age"
    )
